...
<head>
	...
	<script src="${basePath }/pages/home/xuanchuan/bszn.js"></script>
</head>
<body>
	...
	<div class="page-content clearfix">
        ...
        <div class="page-left">
            ...
            <ul>
                ...
                <li url="${basePath }/xuanchuan/bszn" class="active"><div class="title title4"><span><i></i>办事指南</span></div></li>
        ...
        <div class="page-right">
           <div class="page1 page3" id="page3">
                    ...
                    <div class="page1-con">
                        <!--业务指南-->
                        <div class="page-con page3-con1 on">
                            <div class="img" style="background-image: url(${basePath }/static/assets/img/publicity/yewu.jpg)"></div>
                            <div class="content">
                                <ul></ul>
                            </div>
                        </div>
                        <!--申报指南-->
                        <div class="page-con page3-con1">
                            <div class="img" style="background-image: url(${basePath }/static/assets/img/publicity/shengbao.jpg)"></div>
                            <div class="content">
                                <ul></ul>
                            </div>
                        </div>
