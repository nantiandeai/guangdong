...
<title>广东省文化馆-数字展览-${exh.exhtitle }</title>
				...
				<div class="adrList adrList1">
					<span class="item active"><a href="javascript:void(0)" arttyp="">全部</a></span>
						<c:forEach items="${artList }" var="art" varStatus="s">
							<span class="item"><a href="javascript:void(0)" arttyp="${art.id }">${art.name }</a></span>
						</c:forEach>
				</div>--%>
				<!-- 分类-end -->
				
				<!-- 搜索 -->
				<div class="searchCont" style="margin-bottom: 20px;">
