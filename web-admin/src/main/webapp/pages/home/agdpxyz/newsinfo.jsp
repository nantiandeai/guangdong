...
<title>广东省文化馆-培训驿站-培训资讯-${wh_zx_colinfo.clnftltle }</title>
...
<div class="public-crumbs">
    ...
    <span><a href="${basePath }/agdpxyz/news">培训资讯</a></span><span>></span>
		...
		<div class="public-left-main">
			<div class="noticeInfo-main">
				...
				<div class="otherInfo">
					...
					<span class="key">关键字 :${wh_zx_colinfo.clnfkey }</span>
					<span class="time">时间 :<span><fmt:formatDate value="${wh_zx_colinfo.clnfcrttime}"
						...
						<video width="800" height="525" poster="${imgServerAddr }/${loadents.deourl}" controls
							...
							<video width="800" height="525" poster="${basePath }/static/assets/img/public/vedioBg.jpg"
								   controls oncontextmenu="return false">
									...
									<%--  <video width="800" height="525" poster="${basePath }/${loadents.deourl}" controls  oncontextmenu="return false"> --%>
					...
					<div class="file-download-cont">
						<ul>
							<c:forEach items="${loadlist}" var="loadlists" varStatus="s">
								<li>
									<a href="${basePath }/whtools/downFile?filePath=${loadlists.uplink}"><i></i>${loadlists.upname}
									</a>
								</li>
							</c:forEach>
						</ul>
				...
				<div class="next-notice">
					<a href="${basePath }/agdpxyz/newsinfo?id=${wh_zx_colinfo_next.clnfid}">下一篇<span>${wh_zx_colinfo_next.clnftltle}</span></a>
				</div>
