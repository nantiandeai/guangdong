...
<title>广东省文化馆-艺术团队</title>
<%@include file="/pages/comm/comm_head.jsp"%>
<link href="${basePath }/static/assets/css/art/teamList.css" rel="stylesheet">
<script src="${basePath }/pages/home/art/ystd.js"></script>
</head>
<body>
...
<div class="art-nav">
	<div class="main">
    	<ul class="clearfix" id="artMainPageNav">
            ...
            <li class="active"><a href="${basePath }/art/ystd">艺术团队</a><span>/</span></li>
...
<div class="art-main clearfix">
    ...
    <div class="art-right-main">
    	<!-- 内容区 -->
    	<ul class="teamList" id="artContent"></ul>
        <!-- 内容区结束 -->
