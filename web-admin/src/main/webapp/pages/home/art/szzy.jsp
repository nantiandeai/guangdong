...
<head>
    ...
    <title>广东省文化馆-数字资源</title>
    <%@include file="/pages/comm/comm_head.jsp"%>
    <%@include file="/pages/comm/comm_video.jsp"%>
    <link href="${basePath }/static/assets/css/art/digitallist.css" rel="stylesheet">
    <!-- core public JavaScript -->
	<script src="${basePath }/pages/home/art/szzy.js"></script>
</head>
<body>
...
<div class="art-nav">
	<div class="main">
    	<ul class="clearfix" id="artMainPageNav">
            ...
            <li class="active"><a href="${basePath }/art/szzy">数字资源</a></li>
        </ul>
    </div>
</div>
<!--导航结束-->
...
<div class="art-main clearfix">
    ...
    <div class="art-right-main">
        <!-- 内容区 -->
    	<ul class="digitallist clearfix" id="artContent"></ul>
        <!-- 内容区结束 -->
