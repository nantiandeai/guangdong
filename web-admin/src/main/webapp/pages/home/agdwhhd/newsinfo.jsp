...
<title>广东省文化馆-文化活动-活动资讯-${wh_zx_colinfo.clnftltle }</title>
...
<div class="public-crumbs">
    ...
    <span><a href="${basePath }/agdwhhd/news">活动资讯</a></span><span>></span>
		...
		<div class="public-left-main">
            ...
            <div class="file-download-cont">
				...
				<div class="next-notice">
					<a href="${basePath }/agdwhhd/newsinfo?id=${wh_zx_colinfo_next.clnfid}">下一篇<span>${wh_zx_colinfo_next.clnftltle}</span></a>
				</div>
