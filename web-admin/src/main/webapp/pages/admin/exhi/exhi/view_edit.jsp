...
<form id="whgff" class="whgff" method="post">
    ...
    <div class="whgff-row">
        ...
        <div class="whgff-row-input"><input class="easyui-textbox" name="organizer" value="${exhi.organizer}" style="width:600px; height:32px" data-options="required:true, validType:'length[1,30]'"></div>
    </div>
