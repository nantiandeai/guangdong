...
<form id="whgff" class="whgff" method="post">
    ...
    <h2>${param.onlyshow == '1' ? '查看' : '编辑'}志愿活动</h2>

    <input type="hidden" name="zyhdid" value="${zyhdinfo.zyhdid}" />

    <div class="whgff-row">
        <div class="whgff-row-label"><i>*</i>标题：</div>
        <div class="whgff-row-input">
            <input class="easyui-textbox" id="zyhdtitle" name="zyhdtitle" value="${zyhdinfo.zyhdtitle}" style="width:500px;height:35px;" data-options="required:true, validType:'length[1,60]'"/>
        </div>
    </div>
    ...
    <div class="whgff-row">
        ...
        <div class="whgff-row-input">
            <input class="easyui-textbox" id="zyhdshorttitle" name="zyhdshorttitle" value="${zyhdinfo.zyhdshorttitle}" style="width:500px;height:35px;" data-options="required:true, validType:'length[1,60]'"/>
        </div>
    </div>
    ...
    <div class="whgff-row">
        ...
        <div class="whgff-row-input">
            <input id="zyhdarea" class="easyui-combobox" name="zyhdarea" value="${zyhdinfo.zyhdarea}" style="width:500px;height:35px;" data-options="editable:true,limitToList:true,required:true,valueField:'id',textField:'text', data:WhgSysData.getTypeData('6')"/>
        </div>
    </div>
    ...
    <div class="whgff-row">
        ...
        <div class="whgff-row-input">
            <input id="zyhdtype" class="easyui-combobox" name="zyhdtype" value="${zyhdinfo.zyhdtype}" style="width:500px;height:35px;" data-options="editable:true,limitToList:true,valueField:'id',textField:'text',data:WhgSysData.getTypeData('13'),required:true"/>
        </div>
    </div>
    ...
    <div class="whgff-row">
        ...
        <div class="whgff-row-input">
            <input class="easyui-textbox" id="zyhdscope" name="zyhdscope" value="${zyhdinfo.zyhdscope}" style="width:500px;height:35px;" data-options="required:true,validType:'length[1,30]'"/>
        </div>
    </div>
    ...
    <div class="whgff-row">
        ...
        <div class="whgff-row-input">
            <input class="easyui-combobox" id="zyhdstart" name="zyhdstart" value="${zyhdinfo.zyhdstart}" style="width:500px; height:35px"
                    data-options="editable:true,limitToList:false,required:false,valueField:'id',textField:'text',data:WhgComm.getCult(),prompt:'请选择发起的文化馆'"></input>
        </div>
    </div>
    ...
    <div class="whgff-row">
        ...
        <div class="whgff-row-input">
            <input type="hidden" id="hide_picture1" name="zyhdpic" value="${zyhdinfo.zyhdpic}" >
    ...
    <div class="whgff-row">
        ...
        <div class="whgff-row-input">
            <input type="hidden" id="hide_picture2" name="zyhdbigpic" value="${zyhdinfo.zyhdbigpic}">
    ...
    <div class="whgff-row">
        ...
        <div class="whgff-row-input">
            <input id="zyhdaddr" class="easyui-textbox" name="zyhdaddr" value="${zyhdinfo.zyhdaddr}" style="width:500px;height:35px;" data-options="required:true,validType:'length[1,30]'"/>
        </div>
    </div>
    ...
    <div class="whgff-row">
        ...
        <div class="whgff-row-input">
            <input id="zyhdsdate" name="zyhdsdate" class="easyui-datetimebox" value="${zyhdinfo.zyhdsdate}" data-options="editable:false, required:true"  style="width:500px;height:35px;">
        </div>
    </div>
    ...
    <div class="whgff-row">
        ...
        <div class="whgff-row-input">
            <input id="zyhdedate" name="zyhdedate" class="easyui-datetimebox" value="${zyhdinfo.zyhdedate}" data-options="editable:false, required:true" style="width:500px;height:35px;">
        </div>
    </div>
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        if(_readonly){
            ...
            $('#zyhdsdate').datetimebox('readonly', 'readonly');
            $('#zyhdedate').datetimebox('readonly', 'readonly');
        }
    });
</script>
<!-- script END -->
