...
<form id="whgff" class="whgff" method="post" enctype="multipart/form-data" >
    <input type="hidden" name="zyfczzid" value="${zyfczzid}">
    <div class="whgff-row">
        <div class="whgff-row-label"><label style="color: red">*</label>详情标题：</div>
        <div class="whgff-row-input"><input class="easyui-textbox" name="zyfczztitle" value="${org.zyfczztitle}" style="width:600px; height:32px" data-options="required:true, validType:'length[0,60]'"></div>
    </div>
    <div class="whgff-row">
        <div class="whgff-row-label"><label style="color: red">*</label>列表短标题：</div>
        <div class="whgff-row-input"><input class="easyui-textbox" name="zyfczzshorttitle" value="${org.zyfczzshorttitle}" style="width:600px; height:32px" data-options="required:true, validType:'length[0,60]'"></div>
    </div>
    <div class="whgff-row">
        <div class="whgff-row-label"><label style="color: red">*</label>服务地区：</div>
        <div class="whgff-row-input"><input class="easyui-textbox" name="zyfczzscope" value="${org.zyfczzscope}" style="width:600px; height:32px" data-options="required:true, validType:'length[0,200]'"></div>
    </div>
    <div class="whgff-row">
        <div class="whgff-row-label">参与活动：</div>
        <div class="whgff-row-input"><input class="easyui-textbox" name="zyfczzjoinact" value="${org.zyfczzjoinact}" style="width:600px; height:32px" data-options="required:false, validType:'length[0,200]'"></div>
    </div>
    <div class="whgff-row">
        <div class="whgff-row-label">服务时间：</div>
        <div class="whgff-row-input"><input id="zyfczzfwtime" name="zyfczzfwtime" value="${org.zyfczzfwtime}" type="text" class="easyui-numberspinner" data-options="min:1,max:1000000000" style="width:600px; height:32px"></div>
    </div>
    <div class="whgff-row">
        <div class="whgff-row-label">志愿者数量：</div>
        <div class="whgff-row-input"><input id="zyfczzpnum" class="easyui-numberspinner" value="${org.zyfczzpnum}" name="zyfczzpnum" style="width:600px;height:32px;" data-options="min:1,max:1000000000"/></div>
    </div>
    <div class="whgff-row">
        <div class="whgff-row-label">活动数量：</div>
        <div class="whgff-row-input"><input id="zyfczzanum" class="easyui-numberspinner" value="${org.zyfczzanum}" name="zyfczzanum" style="width: 600px;height:32px;" data-options="min:1,max:1000000000"/></div>
    </div>
    <div class="whgff-row">
        <div class="whgff-row-label"><i>*</i>列表页图：</div>
        <div class="whgff-row-input">
            <input type="hidden" id="cult_picture1" name="zyfczzpic" value="${org.zyfczzpic}">
    ...
    <div class="whgff-row">
        ...
        <div class="whgff-row-input">
            <input type="hidden" id="cult_picture2" name="zyfczzbigpic" value="${org.zyfczzbigpic}">
...
<script type="text/javascript">
    ...
    ue_catalog.ready(function () {
        ue_catalog.setContent('${org.zyfczzcontent}')
    });
