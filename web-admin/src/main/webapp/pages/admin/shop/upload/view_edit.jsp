...
<form id="whgff" method="post" class="whgff" enctype="multipart/form-data">
    ...
    <div class="whgff-row">
        ...
        <div class="whgff-row-input"><input class="easyui-textbox" name="upname" value="${upload.upname}" style="width:600px; height:32px" data-options="required:true, validType:'length[0,30]'"></div>
    </div>

    <%--<div class="whgff-row">--%>
        <%--<div class="whgff-row-label">资源地址：</div>--%>
        <%--<div class="whgff-row-input">--%>
            <%--<input class="easyui-filebox" name="uplink_up" id="uplink_up" value="${upload.uplink}"  style="width: 600px;height:35px" data-options="required: true, validType:'isFile[\'uplink_up\', 20485760]', buttonText:'选择文件'"/>--%>
    ...
    <div class="whgff-row">
        ...
        <div class="whgff-row-input">
            <input id="act_filepath1" name="uplink" data-options="required:true" value="${upload.uplink}" style="width:600px;height:32px;"
                   readonly="readonly">
...
<script>
    $(function () {
        ...
        $('#whgff').form({
            novalidate: true,
            url: '${basePath}/admin/shop/douploda?upid='+${upid},
            onSubmit : function() {
