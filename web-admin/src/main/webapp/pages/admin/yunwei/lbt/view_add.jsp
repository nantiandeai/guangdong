...
<form id="whgff" method="post" class="whgff">
    ...
    <div class="whgff-row">
        ...
        <div class="whgff-row-input"><input class="easyui-textbox" name="name" style="width:600px; height:32px"
                                            data-options="required:true, validType:'length[0,30]'"></div>
    </div>
        ...
        <div class="whgff-row-input">
            ...
            <div class="whgff-row-input-imgfile">
                ...
                <c:choose>
                    ...
                    <c:when test="${clazz== '9'}">
                        <i>图片格式为jpg、png、gif，建议图片尺寸 1920*450，大小为2MB以内</i>
                    </c:when>
                    <c:otherwise>
...
<script>
    $(function () {
        var lbt_type = '${clazz}';
        if( lbt_type == '1' ){
            WhgUploadImg.init({basePath: '${basePath}', uploadBtnId: 'imgUploadBtn1', hiddenFieldId: 'cult_picture1', previewImgId: 'previewImg1', needCut:false, cutWidth:1920, cutHeight:430});
        }else if(lbt_type == '3'){
            ...
            WhgUploadImg.init({basePath: '${basePath}', uploadBtnId: 'imgUploadBtn1', hiddenFieldId: 'cult_picture1', previewImgId: 'previewImg1', needCut:false, cutWidth:1920, cutHeight:450});
        }else{
        ...
        $('#whgff').form({
            ...
            url: '${basePath}/admin/yunwei/lbt/add',
            onSubmit: function () {
