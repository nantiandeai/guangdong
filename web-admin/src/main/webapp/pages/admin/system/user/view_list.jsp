...
<table id="whgdg" title="管理员管理" class="easyui-datagrid" style="display: none"
       data-options="fit:true, striped:true, rownumbers:true, fitColumns:true, singleSelect:false, checkOnSelect:true, selectOnCheck:true, pagination:true, toolbar:'#whgdg-tb', url:'${basePath}/admin/system/user/srchList4p'">
    <thead>
    <tr>
        <th data-options="field:'ck', checkbox:true"></th>
        <th data-options="field:'account', width:160">账号</th>
        <th data-options="field:'contactnum', width:160">手机号</th>
        <th data-options="field:'lastlogintime', width:160, formatter:WhgComm.FMTDateTime">最后登录时间</th>
...
<script type="text/javascript">
     ...
     */
    function doAdd() {
        WhgComm.editDialog('${basePath}/admin/system/user/view/add');
    }
