...
<form id="whgff" class="whgff" method="post" enctype="multipart/form-data" >
    ...
    <div class="whgff-row">
        ...
        <div class="whgff-row-input"><input class="easyui-combobox" name="mlproid" style="height:35px;width: 600px"
                                            data-options="multiple:true,editable:true,required:false,prompt:'请选择名录项目',valueField:'mlproid',textField:'mlproshortitel',url:'${basePath}/admin/feiyi/selMingLu'"/></div>
    </div>
    <div class="whgff-row">
