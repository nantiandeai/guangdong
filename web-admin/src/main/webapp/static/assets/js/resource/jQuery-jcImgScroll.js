        ...
        return this.each(function() {
            ...
            object = function(length){
                ...
                this.NumBtnDom = function(list,w,h,l,t){
                    w = this.length*10+w;
                    return "<dl style=\"z-index:11;width:"+w+"px;height:"+h+"px;margin: 20px auto;\">"+ list +"<dl>";
                    // position:absolute;left:"+l+"px;top:"+t+"px;
                };
                this.arrow = function(l,r,w,h,x,y){
                    return "<em class=\"sPrev\" id=\"sPrev\" style=\"position:absolute;cursor:pointer;z-index:10;\"></em><em class=\"sNext\" id=\"sNext\" style=\"position:absolute;cursor:pointer;z-index:10;\"></em>";
                    // width:"+w+"px;height:"+h+"px;left:"+(l-w-x)+"px;
                    // width:"+w+"px;height:"+h+"px;left:"+(r+x)+"px;top:"+y+"px;
                };
            ...
            object.prototype.Initial = function(callback){
                ...
                for(a=0;a<this.length;a++){
                    ...
                    //鑾峰彇鏁板瓧鎸夐挳
                    if(options.NumBtn){
                        var NumStyle = "cursor:pointer;float:left;height:"+this.setNum.height+"px;width:"+this.setNum.width+"px;overflow:hidden;margin-right:10px;";
                        if(this.centerIdx === a){
